		...
		<form class="form-container">
			<%	
				...
				try{ //creating sql connection
					...
					// creating sql insert statement
					String serviceDescription = "New Service";
					sql = "INSERT INTO InChargeOf VALUES('" + serviceDepartment + "', '" + serviceName + "', '" + serviceDescription + "');";
					stmt1 = con.createStatement();
					if(!(serviceName == null || serviceDepartment == null) ){
						stmt1.executeUpdate(sql);
					}
